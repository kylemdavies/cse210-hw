...
class Program
{
    static void Main(string[] args)
    {
        ...
        while (Choice != 4)
        {
            ...
            {
                Console.Clear();
                ReflectingActivity activity3 = new ReflectingActivity("Listing", "This activity will help you reflect on times in your life when you have shown strength and resilience. This will help you recognize the power you have and how you can use it in other aspects of your life.");
